package com.loglrs.propertyservice.api.house.controller;

import com.google.maps.model.LatLng;

import com.loglrs.propertyservice.api.external_service.GeocodingAPIService;
...
import com.loglrs.propertyservice.domain.component_service.house.service.HouseComponentService;
...
public class HouseController {
    ...
    public ResponseEntity createHouse(@IfLogin LoginUserDto loginUserDto, @RequestPart @Valid CreateHouseDto createHouseDto, @RequestPart @Valid Optional<List<MultipartFile>> files, BindingResult bindingResult) {
        ...
        House savedHouse = houseComponentService.createHouse(house, images, createHouseDto.getHouseOffers(), createHouseDto.getHouseRules());
