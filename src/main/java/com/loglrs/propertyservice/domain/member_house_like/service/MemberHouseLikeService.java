package com.loglrs.propertyservice.domain.member_house_like.service;


import com.loglrs.propertyservice.domain.member_house_like.entity.MemberHouseLike;
import com.loglrs.propertyservice.domain.member_house_like.repository.MemberHouseLikeRepository;
...
public class MemberHouseLikeService {
    ...
    public void deleteByMemberIdAndHouseId(Long memberId, Long houseId) {
        memberHouseLikeRepository.deleteByMemberIdAndHouseId(memberId, houseId);
    }

    @Transactional
    public List<MemberHouseLike> findByMemberId(Long id) {
        return memberHouseLikeRepository.findByMemberId(id);
    }
}
